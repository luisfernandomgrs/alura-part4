...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        if (currentIndexToTest == 3)
            extrator = new ExtratorDeConteudoLivre_modelLocalHost();
        else if (currentIndexToTest == 2)
        ...
        for (int i = 0; i < conteudos.size(); i++) {
            ...
            if (currentIndexToTest == 3) {
                geradoraDeFigurinhas.cria(inputStream, "img/output/" + conteudo.id() +
                        ".png", conteudo.titulo());
            } else {
                geradoraDeFigurinhas.cria(inputStream, "img/output/" + conteudo.id() +
                        ".png");
            ...
            System.out.println("\u001b[38;5;226m\u001b[48;5;53m Classificação: " +
                    conteudo.rating() + " \u001b[0m");
